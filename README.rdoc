...
3. Open mysql
4. Create 3 database: describe.me_development, describe.me_test, describe.me_production
...
4. Grant all priviliges for user describedotme
   GRANT ALL PRIVILEGES ON describedotme_development.* TO describedotme;
   GRANT ALL PRIVILEGES ON describedotme_test.* TO describedotme;
   GRANT ALL PRIVILEGES ON describedotme_production.* TO describedotme;
